...
%global repo_name bc_osc_jupyter_vllm
%global app_name bc_osc_jupyter_vllm
...
Summary:  Batch Connect - OSC Jupyter Notebook + vLLM
...
%description
An interactive app designed for OSC OnDemand that launches a Jupyter Notebook server with vLLM running in background within a Cardinal batch job.
...
%changelog
* Mon Dec 22 2025 Heechang Na <hna@osc.edu> 0.1.1
- Initial package build to v0.1.1 (hna@osc.edu)
